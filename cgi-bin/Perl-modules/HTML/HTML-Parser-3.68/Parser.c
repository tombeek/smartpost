...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "HTML::Parser::_alloc_pstate", "self");
...
#endif
    if (items != 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "HTML::Parser::parse", "self, chunk");
    PERL_UNUSED_VAR(cv); /* -W */
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "HTML::Parser::eof", "self");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
XS(XS_HTML__Parser_strict_comment)
{
    ...
    dXSI32;
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", GvNAME(CvGV(cv)), "pstate, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
...
#endif
    if (items < 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "HTML::Parser::boolean_attribute_value", "pstate, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	PSTATE*	pstate = get_pstate_hv(aTHX_ ST(0));
	SV *	RETVAL;
...
#endif
    if (items < 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "HTML::Parser::handler", "pstate, eventname, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    PERL_UNUSED_VAR(ax); /* -Wall */
    SP -= items;
    {
...
#endif
    if (items < 2)
       Perl_croak(aTHX_ "Usage: %s(%s)", "HTML::Entities::_decode_entities", "string, entities, ...");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV*	string = ST(0);
	SV*	entities = ST(1);
...
#endif
    if (items != 1)
       Perl_croak(aTHX_ "Usage: %s(%s)", "HTML::Entities::_probably_utf8_chunk", "string");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	SV*	string = ST(0);
#line 652 "Parser.xs"
...
#endif
    if (items != 0)
       Perl_croak(aTHX_ "Usage: %s(%s)", "HTML::Entities::UNICODE_SUPPORT", "");
    PERL_UNUSED_VAR(cv); /* -W */
    {
	int	RETVAL;
	dXSTARG;
